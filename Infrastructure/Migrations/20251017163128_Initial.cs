        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TermOrder = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AccessControls_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AccessControls_Lessons_LessonId",
                        column: x => x.LessonId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccessControls_Terms_TermId",
                        column: x => x.TermId,
                        principalTable: "Terms",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AccessControls_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessControls_GradeId",
                table: "AccessControls",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessControls_LessonId",
                table: "AccessControls",
                column: "LessonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessControls_TermId",
                table: "AccessControls",
                column: "TermId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessControls_UnitId",
                table: "AccessControls",
                column: "UnitId");
